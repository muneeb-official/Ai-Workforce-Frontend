...
const icons = {
  ...
  support: () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M12 2a10 10 0 0 1 10 10c0 5.52-4.48 10-10 10S2 17.52 2 12"/><circle cx="12" cy="12" r="4"/>
    </svg>
  ),
  train: () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  robot: () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <rect x="3" y="8" width="18" height="12" rx="2"/><path d="M12 8V5"/><circle cx="12" cy="3" r="2"/>
      <circle cx="8" cy="14" r="1.5" fill="currentColor"/><circle cx="16" cy="14" r="1.5" fill="currentColor"/><path d="M9 18h6"/>
    </svg>
  ),
  envelope: () => (
  ...
  inbox: () => (
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 14h6l2 2h4l2-2h6"/>
    </svg>
  ),
  percent: () => (
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <rect x="3" y="3" width="18" height="18" rx="2"/>
      <circle cx="9" cy="9" r="1.5" fill="currentColor"/><circle cx="15" cy="15" r="1.5" fill="currentColor"/><path d="M16 8l-8 8"/>
    </svg>
  ),
  phone: () => (
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
const MeetingCard = ({ meeting }) => (
  <div className="bg-white rounded-xl p-4 border border-gray-100 flex justify-between items-start">
    <div>
      <h3 className="font-semibold text-gray-800">
        {meeting.company} {meeting.title && `– ${meeting.title}`}
      </h3>
      {meeting.description && <p className="text-sm text-gray-500">{meeting.description}</p>}
      <p className="text-sm text-gray-500 mt-1">{meeting.time}</p>
    </div>
    <button className="text-blue-600 font-medium text-sm hover:underline whitespace-nowrap">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex">
      ...
      <div
        ...
        style={{ width: sidebarExpanded ? '200px' : '64px', transition: 'width 0.2s ease' }}
      >
        {/* Logo */}
        ...
        <nav className="flex flex-col gap-1 flex-1">
          {navItems.map((item, idx) => (
            <div key={item.key} style={{ marginTop: idx === navItems.length - 1 ? 'auto' : 0 }}>
              <NavItem
                item={item}
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="flex justify-end items-center p-4 gap-4">
          <div className="flex items-center bg-white rounded-full px-4 py-2 shadow-sm border border-gray-100">
            <span className="text-sm text-gray-600 mr-2">{userData.credits} Credits</span>
            <button className="bg-gray-900 text-white text-sm px-4 py-1.5 rounded-full font-medium">
              Buy Credits
            </button>
          </div>
          <button className="p-2 text-gray-500 hover:bg-white rounded-full">
            <Icon name="bell" />
          </button>
        ...
        <div className="px-8 pb-8">
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 mb-8 border border-gray-100">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h2 className="text-xl font-semibold text-gray-800">Your Credits Usage summary, So far!</h2>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 mb-8 border border-gray-100">
            <div className="flex gap-8">
              <div className="w-1/3">
                ...
                <p className="text-sm text-gray-500 mt-1">Here is a list for this week meetings.</p>
              </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 border border-gray-100">
            <div className="flex gap-8">
              <div className="w-1/3">
                <h2 className="text-xl font-semibold text-gray-800">Meetings Schedule This Week</h2>
                <p className="text-sm text-gray-500 mt-1">Here is a list for this week meetings.</p>
              </div>
              <div className="flex-1 space-y-3">
