        ...
        >
          ...
          {activePage === "sales" && (
            ...
            >
              ...
              {sidebarExpanded && (
                <span className="text-sm font-semibold text-gray-800 whitespace-nowrap px-3 py-1.5 rounded-full bg-white border border-gray-200 group-hover:border-gray-300 transition-all duration-200">
                  Sales Agent
                </span>
              )}
            </button>
